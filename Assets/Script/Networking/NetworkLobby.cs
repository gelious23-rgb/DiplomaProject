...
namespace Script.Networking
{
    public class NetworkLobby : MonoBehaviour
    {
        ...
        private async Task<Allocation> AllocateRelay()
        {
            try
            {
                Allocation allocation = await RelayService.Instance.CreateAllocationAsync(MultiplayerGame.MAX_PLAYER_AMOUNT - 1);
        ...
        public async void CreateLobby(string lobbyName, bool isPrivate)
        {
            ...
            try
            {
                ...
                MultiplayerGame.Instance.StartHost();
            }
            catch (LobbyServiceException e)
            {
                Debug.Log(e);
        ...
        public async void QuickJoin()
        {
            ...
            try
            {
                ...
                MultiplayerGame.Instance.StartClient();
            }
            catch (LobbyServiceException e)
            {
                Debug.Log(e);
        ...
        public async void JoinWithPassword(string lobbyCode)
        {
            OnJoinStarted?.Invoke(this, EventArgs.Empty);
            try
            {
